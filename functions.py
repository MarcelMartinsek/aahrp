...
bounds_arrays = {
	"Schaffer1":       np.array([[-120, 100], [-120, 100]]),
	"Schaffer2":       np.array([[-120, 100], [-120, 100]]),
	"Salomon":         np.array([[-120, 100], [-120, 100], [-120, 100], [-120, 100], [-120, 100]]),
	"Griewank":        np.array([[-550, 500], [-550, 500], [-550, 500], [-550, 500], [-550, 500], [-550, 500], [-550, 500], [-550, 500], [-550, 500], [-550, 500]]),
	"PriceTransistor": np.array([[0, 10], [0, 10], [0, 10], [0, 10], [0, 10], [0, 10], [0, 10], [0, 10], [0, 10]]),
	"Expo":            np.array([[-12, 10], [-12, 10], [-12, 10], [-12, 10], [-12, 10], [-12, 10], [-12, 10], [-12, 10], [-12, 10], [-12, 10]]),
	"Modlangerman":    np.array([[0, 10], [0, 10], [0, 10], [0, 10], [0, 10], [0, 10], [0, 10], [0, 10], [0, 10], [0, 10]]),
	"EMichalewicz":    np.array([[0, np.pi], [0, np.pi], [0, np.pi], [0, np.pi], [0, np.pi]]),
	"Shekelfox5":      np.array([[0, 10], [0, 10], [0, 10], [0, 10], [0, 10]]),
	"Schwefel":        np.array([[-500, 500], [-500, 500], [-500, 500], [-500, 500], [-500, 500], [-500, 500], [-500, 500], [-500, 500], [-500, 500], [-500, 500]])
}
